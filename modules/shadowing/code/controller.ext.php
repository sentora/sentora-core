		...
		if ($numrows = $zdbh->query($sql)) {
 			if ($numrows->fetchColumn() <> 0) {
				...
				while ($rowclients = $sql->fetch()) {
					...
					$line .= "<tr><td>".$clientuserid['username']."</td><td>TODO</td><td>TODO</td><td>TODO</td><td><button class=\"fg-button ui-state-default ui-corner-all\" type=\"submit\" name=\"inShadow_".$rowclients['ac_id_pk']."\">Shadow</button></td></tr>\n";
