...
/*
    ...
    $line .= "# Automatically generated by Sentora " . sys_versions::ShowZpanelVersion() . fs_filehandler::NewLine();
    $line .= "# Generated on: " . date( ctrl_options::GetSystemOption( 'zpanel_df' ), time() ) . fs_filehandler::NewLine();
    $line .= "# ==== YOU MUST NOT EDIT THIS FILE : IT WILL BE OVERWRITED ====" . fs_filehandler::NewLine();
