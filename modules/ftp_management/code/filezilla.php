			...
			if(!empty($matchresult)){
				...
				while ($rowftpaccounts = $sql->fetch()) {
					...
					if ($ftpuser['enabled'] <> 0){
						...
						$line .= "<Option Name=\"Comments\">Auto account generated by ZPanel (v. ".ctrl_options::GetOption('dbversion').")</Option>" . fs_filehandler::NewLine();
						...
						$line .= "<Permission Dir=\"" . ctrl_options::GetOption('hosted_dir') . $ftpuser['username'] . $rowftpaccounts['ft_directory_vc'] . "\">" . fs_filehandler::NewLine();
						// If read only...
