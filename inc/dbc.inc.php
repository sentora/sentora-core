...
try {
    ...
    $error_html = "<style type=\"text/css\"><!--
            ...
            <div class=\"dbwarning\"><strong>Critical Error:</strong> [0100] - Unable to connect or authenticate to the ZPanel database (<em>$dbname</em>).<p>We advise that you contact the server administrator to ensure that the database server is online and that the correct connection parameters are being used.</p></div>";
    die($error_html);
}
?>