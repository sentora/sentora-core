...
<html>
    ...
    <body>
        <a class="header_logo" href="http://www.sentora.io/" target="_blank">
        ...
        <div class="content">
            ...
            <p><b>For more information and help using Sentora please visit:</b> <a href="http://www.sentora.io/" target="_blank">www.sentora.io</a>.</p>
            <p>Kind regards,<br>
                Your hosting company.</p>
        </div>
        <div class="poweredbox">
            <p><strong>Powered by <a href="http://www.sentora.io/" target="_blank">Sentora</a></strong> - The open-source web hosting control panel.</p>
        </div>
    </body>
</html>
