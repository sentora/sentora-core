...
this.start_refresh();this.start_keepalive()}};this.log=function(a){window.console&&console.log&&console.log(a)};this.command=function(a,b,d,e){var f,g,h,k=!1;d&&d.blur&&d.blur();if(this.busy)return!1;if(d&&d.href&&0>String(d.href).indexOf("#")&&rcube_event.get_modifier(e))return!0;if(!this.commands[a])return this.is_framed()&&parent.rcmail.command(a,b),!1;if("mail"==this.task&&"compose"==this.env.action&&0>$.inArray(a,this.env.compose_commands)&&!this.env.server_error){if(this.cmp_hash!=this.compose_field_hash()&&
...
flags:d.extra_flags});var f,g,h,k="",l="",m=this.message_list;h=m.rows;var n=this.env.messages[a],q="message"+(d.seen?"":" unread")+(d.deleted?" deleted":"")+(d.flagged?" flagged":"")+(n.selected?" selected":""),u={cols:[],style:{},id:"rcmrow"+a};f="msgicon";null===this.env.status_col&&(f+=" status",d.deleted?f+=" deleted":d.seen?0<d.unread_children&&(f+=" unreadchildren"):f+=" unread");d.answered&&(f+=" replied");d.forwarded&&(f+=" forwarded");n.selected&&!m.in_selection(a)&&m.selection.push(a);
this.env.threading&&(n.depth?(k+='<span id="rcmtab'+a+'" class="branch" style="width:'+15*n.depth+'px;">&nbsp;&nbsp;</span>',h[n.parent_uid]&&!1===h[n.parent_uid].expanded||!(0!=this.env.autoexpand_threads&&2!=this.env.autoexpand_threads||h[n.parent_uid]&&h[n.parent_uid].expanded)?(u.style.display="none",n.expanded=!1):n.expanded=!0,q+=" thread expanded"):n.has_children&&(void 0===n.expanded&&(1==this.env.autoexpand_threads||2==this.env.autoexpand_threads&&n.unread_children)&&(n.expanded=!0),l='<div id="rcmexpando'+
a+'" class="'+(n.expanded?"expanded":"collapsed")+'">&nbsp;&nbsp;</div>',q+=" thread"+(n.expanded?" expanded":"")),d.unread_children&&d.seen&&!n.expanded&&(q+=" unroot"));k+='<span id="msgicn'+a+'" class="'+f+'">&nbsp;</span>';u.className=q;b.subject&&(h=d.mbox==this.env.drafts_mailbox?"_draft_uid":"_uid",b.subject='<a href="./?_task=mail&_action='+(d.mbox==this.env.drafts_mailbox?"compose":"show")+"&_mbox="+urlencode(d.mbox)+"&"+h+"="+a+'" onclick="return rcube_event.cancel(event)" onmouseover="rcube_webmail.long_subject_title(this,'+
(n.depth+1)+')"><span>'+b.subject+"</span></a>");for(g in this.env.coltypes)f=this.env.coltypes[g],h={className:String(f).toLowerCase()},"flag"==f?(f=d.flagged?"flagged":"unflagged",f='<span id="flagicn'+a+'" class="'+f+'">&nbsp;</span>'):"attachment"==f?f=/application\/|multipart\/(m|signed)/.test(d.ctype)?'<span class="attachment">&nbsp;</span>':/multipart\/report/.test(d.ctype)?'<span class="report">&nbsp;</span>':"&nbsp;":"status"==f?(f=d.deleted?"deleted":d.seen?0<d.unread_children?"unreadchildren":
"msgicon":"unread",f='<span id="statusicn'+a+'" class="'+f+'">&nbsp;</span>'):"threads"==f?f=l:"subject"==f?(bw.ie&&(h.onmouseover=function(){rcube_webmail.long_subject_title_ex(this,n.depth+1)},bw.ie8&&(k="<span></span>"+k)),f=k+b[f]):f="priority"==f?0<d.prio&&6>d.prio?'<span class="prio'+d.prio+'">&nbsp;</span>':"&nbsp;":b[f],h.innerHTML=f,u.cols.push(h);m.insert_row(u,e);e&&this.env.pagesize&&m.rowcount>this.env.pagesize&&(a=m.get_last_row(),m.remove_row(a),m.clear_selection(a))};this.set_list_sorting=
function(a,b){$("#rcm"+this.env.sort_col).removeClass("sorted"+this.env.sort_order.toUpperCase());a&&$("#rcm"+a).addClass("sorted"+b);this.env.sort_col=a;this.env.sort_order=b};this.set_list_options=function(a,b,d,e){var f,g={};void 0===b&&(b=this.env.sort_col);d||(d=this.env.sort_order);if(this.env.sort_col!=b||this.env.sort_order!=d)f=1,this.set_list_sorting(b,d);this.env.threading!=e&&(f=1,g._threads=e);if(a&&a.length){var h,k,l=[],m=this.env.coltypes;for(e=0;e<m.length;e++)k=m[e],h=$.inArray(k,
a),-1!=h&&(l.push(k),delete a[h]);for(e=0;e<a.length;e++)a[e]&&l.push(a[e]);l.join()!=m.join()&&(f=1,g._cols=l.join(","))}f&&this.list_mailbox("","",b+"_"+d,g)};this.show_message=function(a,b,d){if(a){var e,f=window,g="&_action="+(d?"preview":"show")+"&_uid="+a+"&_mbox="+urlencode(this.env.mailbox);d&&(e=this.get_frame_window(this.env.contentframe))&&(f=e,g+="&_framed=1");b&&(g+="&_safe=1");this.env.search_request&&(g+="&_search="+this.env.search_request);g+="&_caps="+urlencode(this.browser_capabilities());
...
this.insert_response=function(a){a=this.env.textresponses[a]?this.env.textresponses[a].text:null;if(!a)return!1;if("1"==$("input[name='_is_html']").val()){var b=tinyMCE.get(this.env.composebody);b.getWin().focus();b.selection.setContent(this.quote_html(a).replace(/\r?\n/g,"<br/>"),{format:"text"})}else{var b=rcube_find_object(this.env.composebody),d=$(b).is(":focus")?this.get_input_selection(b):{start:0,end:0},e=b.value;pre=e.substring(0,d.start);end=e.substring(d.end,e.length);b.value=pre+a+end;
this.set_caret_pos(b,d.start+a.length);b.focus()}};this.save_response=function(){var a,b="";a=!1;if("1"==$("input[name='_is_html']").val()){var d=tinyMCE.get(this.env.composebody);d.getWin().focus();b=d.selection.getContent({format:"text"});b||(b=d.getContent({format:"text"}),a=!0)}else(d=rcube_find_object(this.env.composebody))&&$(d).is(":focus")&&(b=this.get_input_selection(d).text),!b&&d&&(b=d.value,a=!0);a&&(a=b.indexOf("-- \n"),0<a&&(b=b.substring(0,a)));a={};d='<form class="propform"><div class="prop block"><label>'+
this.get_label("responsename")+'</label><input type="text" name="name" id="ffresponsename" size="40" /></div><div class="prop block"><label>'+this.get_label("responsetext")+'</label><textarea name="text" id="ffresponsetext" cols="40" rows="8"></textarea></div></form>';a[this.gettext("save")]=function(a){a=$("#ffresponsename").val();var b=$("#ffresponsetext").val();if(!b)return $("#ffresponsetext").select(),!1;a||(a=b.substring(0,40));var d=l.display_message(l.get_label("savingresponse"),"loading");
l.http_post("settings/responses",{_insert:1,_name:a,_text:b},d);$(this).dialog("close")};a[this.gettext("cancel")]=function(){$(this).dialog("close")};this.show_popup_dialog(d,this.gettext("savenewresponse"),a);$("#ffresponsetext").val(b);$("#ffresponsename").select()};this.add_response_item=function(a){var b=a.key;this.env.textresponses[b]=a;if(this.gui_objects.responseslist){var d=$("<li>").appendTo(this.gui_objects.responseslist);$("<a>").addClass("insertresponse active").attr("href","#").attr("rel",
b).html(this.quote_html(a.name)).appendTo(d).mousedown(function(a){return rcube_event.cancel(a)}).mouseup(function(a){l.command("insert-response",b);$(document.body).trigger("mouseup");return rcube_event.cancel(a)})}};this.edit_responses=function(){};this.delete_response=function(a){!a&&this.responses_list&&(a=this.responses_list.get_selection()[0]);return a&&confirm(this.get_label("deleteresponseconfirm"))?(this.http_post("settings/delete-response",{_key:a},!1),!0):!1};this.stop_spellchecking=function(){var a;
window.tinyMCE&&(a=tinyMCE.get(this.env.composebody))?a.plugins&&a.plugins.spellchecker&&a.plugins.spellchecker.active&&a.execCommand("mceSpellCheck"):(a=this.env.spellcheck)&&a.state&&"ready"!=a.state&&"no_error_found"!=a.state&&$(a.spell_span).trigger("click");this.spellcheck_state()};this.spellcheck_state=function(){var a,b;window.tinyMCE&&(a=tinyMCE.get(this.env.composebody))&&a.plugins&&a.plugins.spellchecker?b=a.plugins.spellchecker.active:(a=this.env.spellcheck)&&a.state&&(b="ready"!=a.state&&
"no_error_found"!=a.state);if(rcmail.buttons.spellcheck)$("#"+rcmail.buttons.spellcheck[0].id)[b?"addClass":"removeClass"]("selected");return b};this.spellcheck_lang=function(){var a;if(window.tinyMCE&&(a=tinyMCE.get(this.env.composebody))&&a.plugins&&a.plugins.spellchecker)return a.plugins.spellchecker.selectedLang;if(this.env.spellcheck)return GOOGIE_CUR_LANG};this.spellcheck_lang_set=function(a){var b;window.tinyMCE&&(b=tinyMCE.get(this.env.composebody))&&b.plugins?b.plugins.spellchecker.selectedLang=
a:this.env.spellcheck&&this.env.spellcheck.setCurrentLanguage(a)};this.spellcheck_resume=function(a,b){if(a){var d=tinyMCE.get(this.env.composebody),e=d.plugins.spellchecker;e.active=1;e._markWords(b);d.nodeChanged()}else{var e=this.env.spellcheck;e.prepare(!1,!0);e.processData(b)}this.spellcheck_state()};this.set_draft_id=function(a){var b;a&&a!=this.env.draft_id&&((b=this.opener())&&"mail"==b.env.task&&""==b.env.action&&b.env.mailbox==this.env.drafts_mailbox&&b.command("checkmail"),this.env.draft_id=
a,$("input[name='_draft_saveid']").val(a),window.frames.savetarget&&window.frames.savetarget.history&&window.frames.savetarget.history.back());this.remove_compose_data(this.env.compose_id)};this.auto_save_start=function(){this.env.draft_autosave&&(this.save_timer=setTimeout(function(){l.command("savedraft")},1E3*this.env.draft_autosave));!this.local_save_timer&&window.localStorage&&(this.compose_type_activity=this.compose_type_activity_last=0,$(document).bind("keypress",function(a){l.compose_type_activity++}),
this.local_save_timer=setInterval(function(){l.compose_type_activity>l.compose_type_activity_last&&(l.save_compose_form_local(),l.compose_type_activity_last=l.compose_type_activity)},5E3));this.busy=!1};this.compose_field_hash=function(a){var b,d,e,f="",g=["to","cc","bcc","subject"];for(d=0;d<g.length;d++)if(e=$('[name="_'+g[d]+'"]').val())f+=e+":";f=window.tinyMCE&&(b=tinyMCE.get(this.env.composebody))?f+b.getContent():f+$("[name='_message']").val();if(this.env.attachments)for(var h in this.env.attachments)f+=
h;a&&(this.cmp_hash=f);return f};this.save_compose_form_local=function(){var a={session:this.env.session_id,changed:(new Date).getTime()},b=!0;window.tinyMCE&&tinyMCE.get(this.env.composebody)&&tinyMCE.triggerSave();this.env.draft_id&&(a.draft_id=this.env.draft_id);this.env.reply_msgid&&(a.reply_msgid=this.env.reply_msgid);$("input, select, textarea",this.gui_objects.messageform).each(function(d,e){switch(e.tagName.toLowerCase()){case "input":if("button"==e.type||"submit"==e.type||"hidden"==e.type&&
"_is_html"!=e.name)break;a[e.name]="checkbox"!=e.type||e.checked?$(e).val():"";""!=a[e.name]&&"hidden"!=e.type&&(b=!1);break;case "select":a[e.name]=$("option:checked",e).val();break;default:a[e.name]=$(e).val(),""!=a[e.name]&&(b=!1)}});if(window.localStorage&&!b){var d=this.local_storage_get_item("compose.index",[]),e=this.env.compose_id;0>$.inArray(e,d)&&d.push(e);this.local_storage_set_item("compose."+e,a,!0);this.local_storage_set_item("compose.index",d)}};this.restore_compose_form=function(a,
b){var d=this.local_storage_get_item("compose."+a,!0);d&&"object"==typeof d&&($.each(d,function(a,b){if("_"==a[0]){var d=$("*[name='"+a+"']");d[0]&&"checkbox"==d[0].type?d.prop("checked",""!=b):d.val(b)}}),"1"==d._is_html?b||(tinyMCE.execCommand("mceAddControl",!1,this.env.composebody),this.triggerEvent("aftertoggle-editor",{mode:"html"})):b&&(tinyMCE.execCommand("mceRemoveControl",!1,this.env.composebody),this.triggerEvent("aftertoggle-editor",{mode:"plain"})))};this.remove_compose_data=function(a){if(window.localStorage){var b=
this.local_storage_get_item("compose.index",[]);0<=$.inArray(a,b)&&(this.local_storage_remove_item("compose."+a),this.local_storage_set_item("compose.index",$.grep(b,function(b,e){return b!=a})))}};this.clear_compose_data=function(){if(window.localStorage){for(var a=this.local_storage_get_item("compose.index",[]),b=0;b<a.length;b++)this.local_storage_remove_item("compose."+a[b]);this.local_storage_remove_item("compose.index")}};this.change_identity=function(a,b){if(!a||!a.options)return!1;b||(b=this.env.show_sig);
if(!this.env.identities_initialized&&(this.env.identities_initialized=!0,this.env.show_sig_later&&(this.env.show_sig=!0),this.env.opened_extwin))return;var d,e,f=-1,g=a.options[a.selectedIndex].value,h=$("[name='_message']"),k=h.val(),l="1"==$("input[name='_is_html']").val(),m=this.env.identity,n=this.env.recipients_separator,q=RegExp.escape(n),u=["replyto","bcc"];for(d in u){e=u[d];var v=m&&this.env.identities[m]?this.env.identities[m][e]:"",s=g&&this.env.identities[g]?this.env.identities[g][e]:
"",w=$('[name="_'+e+'"]'),t=w.val();v&&t&&(e=RegExp("\\s*"+RegExp.escape(v)+"\\s*"),t=t.replace(e,""));e=RegExp(q+"\\s*"+q,"g");t=t.replace(e,n);e=RegExp("^[\\s"+q+"]+");t=t.replace(e,"");s&&-1==t.indexOf(s)&&-1==t.indexOf(s.replace(/"/g,""))&&(t&&(e=RegExp("["+q+"\\s]+$"),t=t.replace(e,"")+n+" "),t+=s+n+" ");(v||s)&&w.val(t).change()}this.env.signatures&&this.env.signatures[g]?(this.enable_command("insert-sig",!0),this.env.compose_commands.push("insert-sig")):this.enable_command("insert-sig",!1);
l?b&&this.env.signatures&&(d=tinyMCE.get(this.env.composebody),h=d.dom.get("_rc_sig"),h||(k=d.getBody(),m=d.getDoc(),h=m.createElement("div"),h.setAttribute("id","_rc_sig"),this.env.top_posting?(d.getWin().focus(),d=d.selection.getNode(),"BODY"==d.nodeName?(k.insertBefore(h,k.firstChild),k.insertBefore(m.createElement("br"),k.firstChild)):(k.insertBefore(h,d.nextSibling),k.insertBefore(m.createElement("br"),d.nextSibling))):(bw.ie&&k.appendChild(m.createElement("br")),k.appendChild(h))),this.env.signatures[g]&&
(h.innerHTML=this.env.signatures[g].html)):(b&&m&&this.env.signatures&&this.env.signatures[m]&&(m=this.env.signatures[m].text,m=m.replace(/\r\n/g,"\n"),f=this.env.top_posting?k.indexOf(m):k.lastIndexOf(m),0<=f&&(k=k.substring(0,f)+k.substring(f+m.length,k.length))),b&&this.env.signatures&&this.env.signatures[g]?(m=this.env.signatures[g].text,m=m.replace(/\r\n/g,"\n"),this.env.top_posting?0<=f?(k=k.substring(0,f)+m+k.substring(f,k.length),d=f-1):k?(pos=this.get_caret_pos(h.get(0)))?(k=k.substring(0,
pos)+"\n"+m+"\n\n"+k.substring(pos,k.length),d=pos):(d=0,k="\n\n"+m+"\n\n"+k.replace(/^[\r\n]+/,"")):(d=0,k="\n\n"+m):(k=k.replace(/[\r\n]+$/,""),d=!this.env.top_posting&&k.length?k.length+1:0,k+="\n\n"+m)):d=this.env.top_posting?0:k.length,h.val(k),this.set_caret_pos(h.get(0),d));this.env.identity=g;this.triggerEvent("change_identity");return!0};this.upload_file=function(a,b){if(!a)return!1;var d=0,e=0;$("input[type=file]",a).each(function(a,b){var f=b.files?b.files.length:b.value?1:0;if(b.files)for(a=
0;a<f;a++)d+=b.files[a].size;e+=f});if(e){if(this.env.max_filesize&&this.env.filesizeerror&&d>this.env.max_filesize)return this.display_message(this.env.filesizeerror,"error"),!1;var f=this.async_upload_form(a,b||"upload",function(a){var b,d="";try{this.contentDocument?b=this.contentDocument:this.contentWindow&&(b=this.contentWindow.document),d=b.childNodes[0].innerHTML}catch(e){}d.match(/add2attachment/)||bw.opera&&(!rcmail.env.uploadframe||rcmail.env.uploadframe!=a.data.ts)||(d.match(/display_message/)||
rcmail.display_message(rcmail.get_label("fileuploaderror"),"error"),rcmail.remove_from_attachment_list(a.data.ts));bw.opera&&(rcmail.env.uploadframe=a.data.ts)}),g="<span>"+this.get_label("uploading"+(1<e?"many":""))+"</span>",h=f.replace(/^rcmupload/,"");this.add2attachment_list(h,{name:"",html:g,classname:"uploading",frame:f,complete:!1});this.env.upload_progress_time&&this.upload_progress_start("upload",h);this.gui_objects.attachmentform=a;return!0}return!1};this.add2attachment_list=function(a,
b,d){if(!this.gui_objects.attachmentlist)return!1;!b.complete&&l.env.loadingicon&&(b.html='<img src="'+l.env.loadingicon+'" alt="" class="uploading" />'+b.html);!b.complete&&b.frame&&(b.html='<a title="'+this.get_label("cancel")+'" onclick="return rcmail.cancel_attachment_upload(\''+a+"', '"+b.frame+'\');" href="#cancelupload" class="cancelupload">'+(this.env.cancelicon?'<img src="'+this.env.cancelicon+'" alt="" />':this.get_label("cancel"))+"</a>"+b.html);var e,f=$("<li>");f.attr("id",a).addClass(b.classname).html(b.html).on("mouseover",
function(){rcube_webmail.long_subject_title_ex(this,0)});d&&(e=document.getElementById(d))?f.replaceAll(e):f.appendTo(this.gui_objects.attachmentlist);d&&this.env.attachments[d]&&delete this.env.attachments[d];this.env.attachments[a]=b;return!0};this.remove_from_attachment_list=function(a){this.env.attachments&&(delete this.env.attachments[a],$("#"+a).remove())};this.remove_attachment=function(a){a&&this.env.attachments[a]&&this.http_post("remove-attachment",{_id:this.env.compose_id,_file:a});return!0};
...
1,d),e=this.env.autocomplete_min_length,d=this.ksearch_data,b=$.trim(b);if(b!=this.ksearch_value)if(this.ksearch_destroy(),b.length&&b.length<e)this.ksearch_info||(this.ksearch_info=this.display_message(this.get_label("autocompletechars").replace("$min",e)));else if(e=this.ksearch_value,this.ksearch_value=b,b.length&&(!(e&&e.length&&b.startsWith(e)&&(!d||0>=d.num)&&this.env.contacts)||this.env.contacts.length)){var f,g,e=(new Date).getTime(),b={_search:b,_id:e},d=a&&a.threads?a.threads:1;f=a&&a.sources?
a.sources:[];a=a&&a.action?a.action:"mail/autocomplete";this.ksearch_data={id:e,sources:f.slice(),action:a,locks:[],requests:[],num:f.length};for(e=0;e<d;e++){f=this.ksearch_data.sources.shift();if(1<d&&void 0===f)break;b._source=f?f:"";f=this.display_message(this.get_label("searching"),"loading");g=this.http_post(a,b,f);this.ksearch_data.locks.push(f);this.ksearch_data.requests.push(g)}}}};this.ksearch_query_results=function(a,b,d){if(this.ksearch_value&&(!this.ksearch_input||b==this.ksearch_value)){var e,
f,g,h,k,p=this.ksearch_value;b=this.ksearch_data;var m=this.env.autocomplete_max?this.env.autocomplete_max:15;this.ksearch_pane||(g=$("<ul>"),this.ksearch_pane=$("<div>").attr("id","rcmKSearchpane").css({position:"absolute","z-index":3E4}).append(g).appendTo(document.body),this.ksearch_pane.__ul=g[0]);g=this.ksearch_pane.__ul;d&&this.ksearch_pane.data("reqid")==d?m-=g.childNodes.length:(this.ksearch_pane.data("reqid",d),g.innerHTML="",this.env.contacts=[],e=$(this.ksearch_input).offset(),this.ksearch_pane.css({left:e.left+
"px",top:e.top+this.ksearch_input.offsetHeight+"px",display:"none"}));if(a&&(f=a.length))for(e=0;e<f&&0<m;e++)k="object"===typeof a[e]?a[e].name:a[e],h=document.createElement("LI"),h.innerHTML=k.replace(RegExp("("+RegExp.escape(p)+")","ig"),"##$1%%").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/##([^%]+)%%/g,"<b>$1</b>"),h.onmouseover=function(){l.ksearch_select(this)},h.onmouseup=function(){l.ksearch_click(this)},h._rcm_id=this.env.contacts.length+e,g.appendChild(h),m-=1;g.childNodes.length&&
(this.ksearch_pane.show(),this.env.contacts.length||($("li:first",g).attr("id","rcmksearchSelected").addClass("selected"),this.ksearch_selected=0));f&&(this.env.contacts=this.env.contacts.concat(a));if(b.id==d)if(b.num--,0<m&&b.sources.length){if(a=b.sources.shift())a={_search:p,_id:d,_source:a},d=this.display_message(this.get_label("searching"),"loading"),b=this.http_post(b.action,a,d),this.ksearch_data.locks.push(d),this.ksearch_data.requests.push(b)}else m||(this.ksearch_msg||(this.ksearch_msg=
this.display_message(this.get_label("autocompletemore"))),this.ksearch_abort())}};this.ksearch_click=function(a){this.ksearch_input&&this.ksearch_input.focus();this.insert_recipient(a._rcm_id);this.ksearch_hide()};this.ksearch_blur=function(){this.ksearch_timer&&clearTimeout(this.ksearch_timer);this.ksearch_input=null;this.ksearch_hide()};this.ksearch_hide=function(){this.ksearch_selected=null;this.ksearch_value="";this.ksearch_pane&&this.ksearch_pane.hide();this.ksearch_destroy()};this.ksearch_destroy=
...
clearTimeout(this.preview_timer);var b,d,e,f,g=this,h=!1,k=this.env.source?this.env.address_sources[this.env.source]:null;(d=a.get_single_selection())?this.preview_timer=setTimeout(function(){g.load_contact(d,"show")},200):this.env.contentframe&&this.show_contentframe(!1);if(a.selection.length){a.draggable=!1;this.env.selection_sources=[];k&&this.env.selection_sources.push(this.env.source);for(b in a.selection)f=a.data[a.selection[b]],k?h=h||!k.readonly&&!f.readonly:(e=String(a.selection[b]).replace(/^[^-]+-/,
""))&&this.env.address_sources[e]&&(h=h||!this.env.address_sources[e].readonly&&!f.readonly,this.env.selection_sources.push(e)),"group"!=f._type&&(a.draggable=!0);this.env.selection_sources=$.unique(this.env.selection_sources)}this.enable_command("group-remove-selected",this.env.group&&0<a.selection.length&&h);this.enable_command("compose",this.env.group||0<a.selection.length);this.enable_command("export-selected","copy",0<a.selection.length);this.enable_command("edit",d&&h);this.enable_command("delete",
"move",0<a.selection.length&&h);return!1};this.list_contacts=function(a,b,d){var e,f={},g=window;a||(a=this.env.source);if(d&&this.current_page==d&&a==this.env.source&&b==this.env.group)return!1;a!=this.env.source?(d=this.env.current_page=1,this.reset_qsearch()):b!=this.env.group&&(d=this.env.current_page=1);this.env.search_id?e="S"+this.env.search_id:this.env.search_request||(e=b?"G"+a+b:a);this.env.source=a;this.env.group=b;var h=$.inArray(this.env.group,this.env.address_group_stack);this.env.address_group_stack=
0>h?[]:this.env.address_group_stack.slice(0,h);this.env.group?(this.env.address_group_stack.push(this.env.group),e="G"+a+this.env.address_group_stack[0]):this.gui_objects.addresslist_title&&$(this.gui_objects.addresslist_title).html(this.get_label("contacts"));this.select_folder(e,"",!0);if(this.gui_objects.contactslist)this.list_contacts_remote(a,b,d);else{if(e=this.get_frame_window(this.env.contentframe))g=e,f._framed=1;b&&(f._gid=b);d&&(f._page=d);a&&(f._source=a);this.env.search_request&&(f._search=
this.env.search_request);this.set_busy(!0,"loading");this.location_href(f,g)}};this.list_contacts_remote=function(a,b,d){this.list_contacts_clear();var e={},f=this.set_busy(!0,"loading");a&&(e._source=a);d&&(e._page=d);b&&(e._gid=b);this.env.source=a;this.env.group=b;this.env.search_request&&(e._search=this.env.search_request);this.http_request("mail"==this.env.task?"list-contacts":"list",e,f)};this.list_contacts_clear=function(){this.contact_list.data={};this.contact_list.clear(!0);this.show_contentframe(!1);
this.enable_command("delete","move","copy",!1);this.enable_command("compose",this.env.group?!0:!1)};this.set_group_prop=function(a){if(this.gui_objects.addresslist_title){var b=$(this.gui_objects.addresslist_title).html("");1<this.env.address_group_stack.length&&($('<a href="#list">...</a>').addClass("poplink").appendTo(b).click(function(a){return l.command("popgroup","",this)}),b.append("&nbsp;&raquo;&nbsp;"));b.append($("<span>").text(a.name))}this.triggerEvent("groupupdate",a)};this.load_contact=
function(a,b,d){var e,f={},g=window,h=this.contact_list?this.contact_list.data[a]:null;if(e=this.get_frame_window(this.env.contentframe))f._framed=1,g=e,this.show_contentframe(!0),a||this.contact_list.clear_selection(),this.enable_command("compose",h&&h.email),this.enable_command("export-selected",h&&"group"!=h._type);else if(d)return!1;!b||!a&&"add"!=b||this.drag_active||(this.env.group&&(f._gid=this.env.group),f._action=b,f._source=this.env.source,f._cid=a,this.location_href(f,g,!0));return!0};
this.group_member_change=function(a,b,d,e){a="add"==a?"add":"del";var f=this.get_label("add"==a?"addingmember":"removingmember"),f=this.display_message(f,"loading");this.http_post("group-"+a+"members",{_cid:b,_source:d,_gid:e},f)};this.contacts_drag_menu=function(a,b){var d="group"==b.type?b.source:b.id,e=this.env.source;if(!this.env.address_sources[d]||this.env.address_sources[d].readonly)return!0;""==e&&1==this.env.selection_sources.length&&(e=this.env.selection_sources[0]);return"group"==b.type&&
d==e?(e=this.contact_list.get_selection().join(","),this.group_member_change("add",e,d,b.id),!0):this.commands.move||rcube_event.get_modifier(a)==SHIFT_KEY?this.drag_menu(a,b):(this.copy_contacts(b),!0)};this.copy_contacts=function(a){var b="group"==a.type?a.source:a.id,d=this.env.source,e=this.env.group?this.env.group:"",f=this.contact_list.get_selection().join(",");f&&this.env.address_sources[b]&&!this.env.address_sources[b].readonly&&(""==d&&1==this.env.selection_sources.length&&(d=this.env.selection_sources[0]),
...
f=[],g=this.display_message(this.get_label("delete"==a?"contactdeleting":"movingcontact"),"loading");if(this.env.cid)f.push(this.env.cid);else{for(e=0;e<d.length;e++)id=d[e],f.push(id),this.contact_list.remove_row(id,e==d.length-1);1==d.length&&this.show_contentframe(!1)}b||(b={});b._source=this.env.source;b._from=this.env.action;b._cid=f.join(",");this.env.group&&(b._gid=this.env.group);this.env.search_request&&(b._search=this.env.search_request);this.http_post(a,b,g);return!0}};this.update_contact_row=
function(a,b,d,e,f){var g=this.contact_list;a=this.html_identifier(a);g.rows[a]||(a=a+"-"+e,d&&(d=d+"-"+e));g.update_row(a,b,d,!0);g.data[a]=f};this.add_contact_row=function(a,b,d,e){if(!this.gui_objects.contactslist)return!1;var f,g=this.contact_list,h={cols:[]};h.id="rcmrow"+this.html_identifier(a);h.className="contact "+(d||"");g.in_selection(a)&&(h.className+=" selected");for(f in b)d={},d.className=String(f).toLowerCase(),d.innerHTML=b[f],h.cols.push(d);g.data[a]=e;g.insert_row(h);this.enable_command("export",
0<g.rowcount)};this.init_contact_form=function(){var a=this,b;if(this.env.coltypes)for(b in this.set_photo_actions($("#ff_photo").val()),this.env.coltypes)this.init_edit_field(b,null);$(".contactfieldgroup .row a.deletebutton").click(function(){a.delete_edit_field(this);return!1});$("select.addfieldmenu").change(function(b){a.insert_edit_field($(this).val(),$(this).attr("rel"),this);this.selectedIndex=0});$.datepicker&&this.env.date_format&&($.datepicker.setDefaults({dateFormat:this.env.date_format,
...
this.set_busy(!0,"groupdeleting");this.http_post("group-delete",{_source:this.env.source,_gid:this.env.group},a)}};this.remove_group_item=function(a){var b="G"+a.source+a.id;this.treelist.remove(b)&&(this.triggerEvent("group_delete",{source:a.source,id:a.id}),delete this.env.contactfolders[b],delete this.env.contactgroups[b]);this.list_contacts(a.source,0)};this.add_input_row=function(a){if(this.gui_objects.folderlist){if(!this.name_input){this.name_input=$("<input>").attr("type","text").data("tt",
a);this.name_input.bind("keydown",function(a){return rcmail.add_input_keydown(a)});this.name_input_li=$("<li>").addClass(a).append(this.name_input);var b;a="contactsearch"==a?this.gui_objects.folderlist:$("ul.groups",this.get_folder_li(this.env.source,"",!0));b=$("li:last",a);b.length?this.name_input_li.insertAfter(b):(this.name_input_li.appendTo(a),a.show())}this.name_input.select().focus()}};this.group_remove_selected=function(){l.http_post("group-delmembers",{_cid:this.contact_list.selection,_source:this.env.source,
_gid:this.env.group})};this.remove_group_contacts=function(a){if("undefined"!=typeof this.env.group&&this.env.group===a.gid){var b=this.contact_list.get_selection();for(a=0;a<b.length;a++)id=b[a],this.contact_list.remove_row(id,a==b.length-1)}};this.add_input_keydown=function(a){var b=rcube_event.get_keycode(a),d=$(a.target);a=d.data("tt");if(13==b){if(b=d.val())d=this.set_busy(!0,"loading"),"contactsearch"==a?this.http_post("search-create",{_search:this.env.search_request,_name:b},d):this.env.group_renaming?
this.http_post("group-rename",{_source:this.env.source,_gid:this.env.group,_name:b},d):this.http_post("group-create",{_source:this.env.source,_name:b},d);return!1}27==b&&this.reset_add_input();return!0};this.reset_add_input=function(){if(this.name_input){var a=this.name_input.parent();this.env.group_renaming?(a.children().last().show(),this.env.group_renaming=!1):1==$("li",a.parent()).length&&a.parent().hide();this.name_input.remove();this.name_input_li&&this.name_input_li.remove();this.name_input=
this.name_input_li=null}this.enable_command("list","listgroup",!0)};this.insert_contact_group=function(a){this.reset_add_input();a.type="group";var b="G"+a.source+a.id,d=$("<a>").attr("href","#").attr("rel",a.source+":"+a.id).click(function(){return rcmail.command("listgroup",a,this)}).html(a.name);this.env.contactfolders[b]=this.env.contactgroups[b]=a;this.treelist.insert({id:b,html:d,classes:["contactgroup"]},a.source,!0);this.triggerEvent("group_insert",{id:a.id,source:a.source,name:a.name,li:this.treelist.get_item(b)})};
this.update_contact_group=function(a){this.reset_add_input();var b="G"+a.source+a.id,d={};if(a.newid){var e="G"+a.source+a.newid,f=$.extend({},a);this.env.contactfolders[e]=this.env.contactfolders[b];this.env.contactfolders[e].id=a.newid;this.env.group=a.newid;delete this.env.contactfolders[b];delete this.env.contactgroups[b];f.id=a.newid;f.type="group";d.id=e;d.html=$("<a>").attr("href","#").attr("rel",a.source+":"+a.newid).click(function(){return rcmail.command("listgroup",f,this)}).html(a.name)}else $(this.treelist.get_item(b)).children().first().html(a.name),
this.env.contactfolders[b].name=this.env.contactgroups[b].name=a.name;this.treelist.update(b,d,!0);this.triggerEvent("group_update",{id:a.id,source:a.source,name:a.name,li:this.treelist.get_item(b),newid:a.newid})};this.update_group_commands=function(){var a=""!=this.env.source?this.env.address_sources[this.env.source]:null;this.enable_command("group-create",a&&a.groups&&!a.readonly);this.enable_command("group-rename","group-delete",a&&a.groups&&this.env.group&&!a.readonly)};this.init_edit_field=
function(a,b){var d=this.env.coltypes[a].label;b||(b=$(".ff_"+a));d&&b.placeholder(d)};this.insert_edit_field=function(a,b,d){var e=$("#ff_"+a);if(e.length)e.show().focus(),$(d).children('option[value="'+a+'"]').prop("disabled",!0);else{$(".ff_"+a);e=$("#contactsection"+b+" .contactcontroller"+a);if(!e.length){b=$("#contactsection"+b);var f=$(".contactfieldgroup",b).last(),e=$("<fieldset>").addClass("contactfieldgroup contactcontroller"+a);f.length?e.insertAfter(f):b.prepend(e)}if(e.length&&"FIELDSET"==
e.get(0).nodeName){var g;b=this.env.coltypes[a];var f=$("<div>").addClass("row"),h=$("<div>").addClass("contactfieldcontent data"),k=$("<div>").addClass("contactfieldlabel label");b.subtypes_select?k.html(b.subtypes_select):k.html(b.label);var p=1!=b.limit?"[]":"";if("text"==b.type||"date"==b.type)g=$("<input>").addClass("ff_"+a).attr({type:"text",name:"_"+a+p,size:b.size}).appendTo(h),this.init_edit_field(a,g),"date"==b.type&&$.datepicker&&g.datepicker();else if("textarea"==b.type)g=$("<textarea>").addClass("ff_"+
a).attr({name:"_"+a+p,cols:b.size,rows:b.rows}).appendTo(h),this.init_edit_field(a,g);else if("composite"==b.type){var m,n,q=[],u=[];if(g=this.env[a+"_template"])for(m=0;m<g.length;m++)q.push(g[m][1]),u.push(g[m][2]);else for(m in b.childs)q.push(m);for(var v=0;v<q.length;v++)m=q[v],g=b.childs[m],g=$("<input>").addClass("ff_"+m).attr({type:"text",name:"_"+m+p,size:g.size}).appendTo(h),h.append(u[v]||" "),this.init_edit_field(m,g),n||(n=g);g=n}else if("select"==b.type){g=$("<select>").addClass("ff_"+
a).attr("name","_"+a+p).appendTo(h);var s=g.attr("options");s[s.length]=new Option("---","");b.options&&$.each(b.options,function(a,b){s[s.length]=new Option(b,a)})}g&&($('<a href="#del"></a>').addClass("contactfieldbutton deletebutton").attr({title:this.get_label("delete"),rel:a}).html(this.env.delbutton).click(function(){l.delete_edit_field(this);return!1}).appendTo(h),f.append(k).append(h).appendTo(e.show()),g.first().focus(),b.count||(b.count=0),++b.count==b.limit&&b.limit&&$(d).children('option[value="'+
a+'"]').prop("disabled",!0))}}};this.delete_edit_field=function(a){var b=$(a).attr("rel"),d=this.env.coltypes[b],e=$(a).parents("fieldset.contactfieldgroup"),f=e.parent().find("select.addfieldmenu");0>=--d.count&&d.visible?$(a).parent().children("input").val("").blur():($(a).parents("div.row").remove(),e.children("div.row").length||e.hide());f.length&&(a=f.children('option[value="'+b+'"]'),a.length?a.prop("disabled",!1):$("<option>").attr("value",b).html(d.label).appendTo(f),f.show())};this.upload_contact_photo=
...
this.create_folder=function(){this.show_folder("",this.env.mailbox)};this.delete_folder=function(a){a=this.get_folder_row_id(a?a:this.env.mailbox);if((a=this.env.subscriptionrows[a][0])&&confirm(this.get_label("deletefolderconfirm"))){var b=this.set_busy(!0,"folderdeleting");this.http_post("delete-folder",{_mbox:a},b)}};this.add_folder_row=function(a,b,d,e,f,g){if(!this.gui_objects.subscriptionlist)return!1;var h,k,l,m,n=[],q=[],u=[],v=this.gui_objects.subscriptionlist.tBodies[0];h=$("tr",v).get(1);
var s="rcmrow"+(new Date).getTime();if(!h)return this.goto_url("folders"),!1;h=$(h).clone(!0);h.attr({id:s,"class":g});h.find("td:first").html(b);$('input[name="_subscribed[]"]',h).val(a).prop({checked:e?!0:!1,disabled:d?!0:!1});this.env.subscriptionrows[s]=[a,b,!1];var w=RegExp(RegExp.escape(this.env.delimiter),"g"),t=String.fromCharCode(0);$.each(this.env.subscriptionrows,function(a,b){if(4>b.length){var d=b[0],d=d.replace(w,t);b.push(d)}n.push(b)});n.sort(function(a,b){var d=a.length-1;n1=a[d];
n2=b[d];return n1<n2?-1:1});for(k in n)n[k][2]?(b=n[k][0]+this.env.delimiter,b!=this.env.prefix_ns&&(u.push(n[k][0]),l=b)):l&&n[k][0].startsWith(l)?u.push(n[k][0]):(q.push(n[k][0]),l=null);for(k=0;k<u.length;k++)a.startsWith(u[k]+this.env.delimiter)&&(m=this.get_folder_row_id(u[k]));for(k=0;!m&&k<q.length;k++)k&&q[k]==a&&(m=this.get_folder_row_id(q[k-1]));m?$("#"+m).after(h):h.appendTo(v);this.subscription_list.clear_selection();f||this.init_subscription_list();h=h.get(0);h.scrollIntoView&&h.scrollIntoView();
return h};this.replace_folder_row=function(a,b,d,e,f){if(!this.gui_objects.subscriptionlist)return this.is_framed?parent.rcmail.replace_folder_row(a,b,d,e,f):!1;var g,h,k,l,m=this.get_folder_row_id(a),n=a.length;g=$('input[name="_subscribed[]"]',$("#"+m)).prop("checked");var q=this.get_subfolders(a);if(a==b)$("#"+m).attr("class",f||""),this.subscription_list.focus();else{this._remove_folder_row(m);e=$(this.add_folder_row(b,d,e,g,!0,f));if(d=q.length)l=a.split(this.env.delimiter).length-b.split(this.env.delimiter).length;
for(a=0;a<d;a++)if(m=q[a],g=this.env.subscriptionrows[m][0],f=this.env.subscriptionrows[m][1],h=$("#"+m),k=h.clone(!0),h.remove(),e.after(k),e=k,g=b+g.slice(n),$('input[name="_subscribed[]"]',e).val(g),this.env.subscriptionrows[m][0]=g,0!=l){if(0<l)for(g=l;0<g;g--)f=f.replace(/^&nbsp;&nbsp;&nbsp;&nbsp;/,"");else for(g=l;0>g;g++)f="&nbsp;&nbsp;&nbsp;&nbsp;"+f;e.find("td:first").html(f);this.env.subscriptionrows[m][1]=f}this.init_subscription_list()}};this.remove_folder_row=function(a,b){var d,e,f=
[];d=this.get_folder_row_id(a);b&&(f=this.get_subfolders(a));this._remove_folder_row(d);d=0;for(e=f.length;d<e;d++)this._remove_folder_row(f[d])};this._remove_folder_row=function(a){this.subscription_list.remove_row(a.replace(/^rcmrow/,""));$("#"+a).remove();delete this.env.subscriptionrows[a]};this.get_subfolders=function(a){for(var b=[],d=a+this.env.delimiter,e=$("#"+this.get_folder_row_id(a)).get(0);e=e.nextSibling;)if(e.id)if((a=this.env.subscriptionrows[e.id][0])&&a.startsWith(d))b.push(e.id);
...
b)},d);return g};this.hide_message=function(a,b){if(this.is_framed())return parent.rcmail.hide_message(a,b);if(this.gui_objects.message){var d,e,f,g,h=this.messages;if("object"===typeof a)g=$(a),d=g.data("key"),this.hide_message_object(g,b),h[d]&&delete h[d];else for(d in h)for(e in h[d].elements)if(h[d]&&h[d].elements[e]==a)if(h[d].elements.splice(e,1),!h[d].elements.length)this.hide_message_object(h[d].obj,b),delete h[d];else if("loading"==d)for(f in h[d].labels)h[d].labels[f].id==a?delete h[d].labels[f]:
(g=h[d].labels[f].msg,h[d].obj.html(g))}};this.hide_message_object=function(a,b){b?a.fadeOut(600,function(){$(this).remove()}):a.hide().remove()};this.clear_messages=function(){if(this.is_framed())return parent.rcmail.clear_messages();var a,b,d=this.messages;for(a in d)for(b in d[a].elements)d[a].obj&&this.hide_message_object(d[a].obj);this.messages={}};this.show_popup_dialog=function(a,b,d,e){if(this.is_framed())return parent.rcmail.show_popup_dialog(a,b,d,e);a=$('<div class="popup">').html(a).dialog($.extend({title:b,
...
{folder:a,mark:b,status:!1})};this.get_folder_li=function(a,b,d){b||(b="rcmli");if(this.gui_objects.folderlist)return a=this.html_identifier(a,d),document.getElementById(b+a)};this.set_message_coltypes=function(a,b,d){var e=this.message_list,f=e?e.thead:null,g,h,k;this.env.coltypes=a;if(f){if(b){g=document.createElement("thead");k=document.createElement("tr");c=0;for(h=b.length;c<h;c++)a=document.createElement("td"),a.innerHTML=b[c].html||"",b[c].id&&(a.id=b[c].id),b[c].className&&(a.className=b[c].className),
k.appendChild(a);g.appendChild(k);f.parentNode.replaceChild(g,f);e.thead=f=g}g=0;for(h=this.env.coltypes.length;g<h;g++)b=this.env.coltypes[g],!(a=f.rows[0].cells[g])||"from"!=b&&"to"!=b&&"fromto"!=b||(a.id="rcm"+b,$("span,a",a).text(this.get_label("fromto"==b?d:b)),$("a",a).click(function(){return rcmail.command("sort",this.id.replace(/^rcm/,""),this)}))}this.env.subject_col=null;this.env.flagged_col=null;this.env.status_col=null;0<=(g=$.inArray("subject",this.env.coltypes))&&(this.env.subject_col=
...
e,f,g,h;if(f=this.get_folder_li(a,"",!0)){g=this.env.unread_counts[a]?this.env.unread_counts[a]:0;e=$(f).children("a").eq(0);d=e.children("span.unreadcount");!d.length&&g&&(d=$("<span>").addClass("unreadcount").appendTo(e));e=0;if((h=f.getElementsByTagName("div")[0])&&h.className.match(/collapsed/))for(var k in this.env.unread_counts)k.startsWith(a+this.env.delimiter)&&(e+=this.env.unread_counts[k]);g&&d.length?d.html(this.env.unreadwrap.replace(/%[sd]/,g)):d.length&&d.remove();d=RegExp(RegExp.escape(this.env.delimiter)+
"[^"+RegExp.escape(this.env.delimiter)+"]+$");a.match(d)&&this.set_unread_count_display(a.replace(d,""),!1);0<g+e?$(f).addClass("unread"):$(f).removeClass("unread")}d=/^\([0-9]+\)\s+/i;b&&document.title&&(f="",f=String(document.title),f=g&&f.match(d)?f.replace(d,"("+g+") "):g?"("+g+") "+f:f.replace(d,""),this.set_pagetitle(f))};this.set_headers=function(a){this.gui_objects.all_headers_row&&this.gui_objects.all_headers_box&&a&&$(this.gui_objects.all_headers_box).html(a).show()};this.show_headers=function(a,
b){if(this.gui_objects.all_headers_row&&this.gui_objects.all_headers_box&&this.env.uid&&($(b).removeClass("show-headers").addClass("hide-headers"),$(this.gui_objects.all_headers_row).show(),b.onclick=function(){rcmail.command("hide-headers","",b)},!this.gui_objects.all_headers_box.innerHTML)){var d=this.display_message(this.get_label("loading"),"loading");this.http_post("headers",{_uid:this.env.uid},d)}};this.hide_headers=function(a,b){this.gui_objects.all_headers_row&&this.gui_objects.all_headers_box&&
($(b).removeClass("hide-headers").addClass("show-headers"),$(this.gui_objects.all_headers_row).hide(),b.onclick=function(){rcmail.command("show-headers","",b)})};this.folder_selector=function(a,b){var d=this.folder_selector_element;if(!d){var e=[],f=this.env.delimiter,g=$('<ul class="toolbarmenu iconized">'),h=document.createElement("li"),k=document.createElement("a"),p=document.createElement("span"),d=$('<div id="folder-selector" class="popupmenu"></div>');k.href="#";k.className="icon";$.each(this.env.mailboxes_list,
function(){var a,b=a=0,g=l.env.mailboxes[this],m=g.id,s=k.cloneNode(!1),w=h.cloneNode(!1);g.virtual?s.className+=" virtual":(s.className+=" active",s.onclick=function(){d.hide().data("callback")(g.id)});g["class"]&&(s.className+=" "+g["class"]);for(;0<=(b=m.indexOf(f,b));)a++,b++;s.style.paddingLeft=a?16*a+"px":0;a=p.cloneNode(!1);$(a).text(g.name);s.appendChild(a);w.appendChild(s);e.push(w)});g.append(e).appendTo(d);d.css({left:"-1000px",top:"-1000px"}).appendTo($("body")).show();10<e.length&&d.css("max-height",
10*$("li",d)[0].offsetHeight+9);var m=function(a){a.target!=d.get(0)&&d.hide()};$(document.body).on("mouseup",m);$("iframe").contents().on("mouseup",m).load(function(a){try{$(this).contents().on("mouseup",m)}catch(b){}});this.folder_selector_element=d}this.element_position(d,a);d.show().data("callback",b)};this.element_position=function(a,b){b=$(b);var d=$(window),e=b.outerWidth(),f=b.outerHeight(),g=b.data("menu-pos"),h=d.height(),k=$(a).height(),l=$(a).width(),m=b.offset(),n=m.top,m=m.left+e;"bottom"==
g?(n+=f,m-=e):m-=5;n+k>h&&(n-=k-f,0>n&&(n=Math.max(0,(h-k)/2)));m+l>d.width()&&(m-=l+e);a.css({left:m+"px",top:n+"px"})};this.html2plain=function(a,b){var d=this,e=this.set_busy(!0,"converting");this.log("HTTP POST: ?_task=utils&_action=html2text");$.ajax({type:"POST",url:"?_task=utils&_action=html2text",data:a,contentType:"application/octet-stream",error:function(a,b,h){d.http_error(a,b,h,e)},success:function(a){d.set_busy(!1,null,e);$("#"+b).val(a);d.log(a)}})};this.plain2html=function(a,b){var d=
this.set_busy(!0,"converting");a=a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");$("#"+b).val(a?"<pre>"+a+"</pre>":"");this.set_busy(!1,null,d)};this.url=function(a,b){var d="string"===typeof b?"&"+b:"";"string"!==typeof a?b=a:b&&"object"===typeof b||(b={});b._action=a?a:this.env.action;var e=this.env.comm_path,f,g={};b._action.match(/([a-z0-9_-]+)\/([a-z0-9-_.]+)/)&&(b._action=RegExp.$2,e=e.replace(/\_task=[a-z0-9_-]+/,"_task="+RegExp.$1));for(f in b)void 0!==b[f]&&null!==b[f]&&
(g[f]=b[f]);return e+"&"+$.param(g)+d};this.redirect=function(a,b){(b||null===b)&&this.set_busy(!0);this.is_framed()?parent.rcmail.redirect(a,b):(this.env.extwin&&("string"==typeof a?a+=(0>a.indexOf("?")?"?":"&")+"_extwin=1":a._extwin=1),this.location_href(a,window))};this.goto_url=function(a,b,d){this.redirect(this.url(a,b))};this.location_href=function(a,b,d){d&&this.lock_frame();"object"==typeof a&&(a=this.env.comm_path+"&"+$.param(a));bw.ie&&b==window?$("<a>").attr("href",a).appendTo(document.body).get(0).click():
b.location.href=a;this.start_keepalive()};this.http_request=function(a,b,d){var e=this.url(a,b);b=this.triggerEvent("request"+a,b);if(void 0!==b){if(!1===b)return!1;e=this.url(a,b)}e+="&_remote=1";this.log("HTTP GET: "+e);this.start_keepalive();return $.ajax({type:"GET",url:e,data:{_unlock:d?d:0},dataType:"json",success:function(a){l.http_response(a)},error:function(b,e,h){l.http_error(b,e,h,d,a)}})};this.http_post=function(a,b,d){var e=this.url(a);b&&"object"===typeof b?(b._remote=1,b._unlock=d?
d:0):b+=(b?"&":"")+"_remote=1"+(d?"&_unlock="+d:"");var f=this.triggerEvent("request"+a,b);if(void 0!==f){if(!1===f)return!1;b=f}this.log("HTTP POST: "+e);this.start_keepalive();return $.ajax({type:"POST",url:e,data:b,dataType:"json",success:function(a){l.http_response(a)},error:function(b,e,f){l.http_error(b,e,f,d,a)}})};this.abort_request=function(a){a.request&&a.request.abort();a.lock&&this.set_busy(!1,null,a.lock)};this.http_response=function(a){if(a){a.unlock&&this.set_busy(!1);this.triggerEvent("responsebefore",
{response:a});this.triggerEvent("responsebefore"+a.action,{response:a});a.env&&this.set_env(a.env);if("object"===typeof a.texts)for(var b in a.texts)"string"===typeof a.texts[b]&&this.add_label(b,a.texts[b]);a.exec&&(this.log(a.exec),eval(a.exec));if(a.callbacks&&a.callbacks.length)for(b=0;b<a.callbacks.length;b++)this.triggerEvent(a.callbacks[b][0],a.callbacks[b][1]);switch(a.action){case "delete":if("addressbook"==this.task){var d;b=this.contact_list.get_selection();d=!1;b&&this.contact_list.rows[b]&&
(d=""==this.env.source?(d=String(b).replace(/^[^-]+-/,""))&&this.env.address_sources[d]&&!this.env.address_sources[d].readonly:!this.env.address_sources[this.env.source].readonly);this.enable_command("compose",b&&this.contact_list.rows[b]);this.enable_command("delete","edit",d);this.enable_command("export",this.contact_list&&0<this.contact_list.rowcount);this.enable_command("export-selected",!1)}case "move":"show"==this.env.action?(this.enable_command(this.env.message_commands,!0),this.env.list_post||
this.enable_command("reply-list",!1)):"addressbook"==this.task&&this.triggerEvent("listupdate",{folder:this.env.source,rowcount:this.contact_list.rowcount});case "purge":case "expunge":"mail"==this.task&&(this.env.exists||(this.env.contentframe&&this.show_contentframe(!1),this.enable_command(this.env.message_commands,"purge","expunge","select-all","select-none","expand-all","expand-unread","collapse-all",!1)),this.message_list&&this.triggerEvent("listupdate",{folder:this.env.mailbox,rowcount:this.message_list.rowcount}));
break;case "refresh":case "check-recent":$.each(this.env.recent_flags||{},function(a,b){l.set_message(a,"deleted",b.deleted);l.set_message(a,"replied",b.answered);l.set_message(a,"unread",!b.seen);l.set_message(a,"forwarded",b.forwarded);l.set_message(a,"flagged",b.flagged)}),delete this.env.recent_flags;case "getunread":case "search":this.env.qsearch=null;case "list":"mail"==this.task?(this.enable_command("show","select-all","select-none",0<this.env.messagecount),this.enable_command("expunge",this.env.exists),
this.enable_command("purge",this.purge_mailbox_test()),this.enable_command("expand-all","expand-unread","collapse-all",this.env.threading&&this.env.messagecount),"list"!=a.action&&"search"!=a.action||!this.message_list||(this.msglist_select(this.message_list),this.triggerEvent("listupdate",{folder:this.env.mailbox,rowcount:this.message_list.rowcount}))):"addressbook"==this.task&&(this.enable_command("export",this.contact_list&&0<this.contact_list.rowcount),"list"==a.action||"search"==a.action)&&(this.enable_command("search-create",
...
a&&window.setTimeout(function(){l.redirect(a,!0)},2E3)};this.iframe_loaded=function(a){this.set_busy(!1,null,a);this.submit_timer&&clearTimeout(this.submit_timer)};this.async_upload_form=function(a,b,d){var e,f=(new Date).getTime(),g="rcmupload"+f;if(this.env.upload_progress_name){e=this.env.upload_progress_name;var h=$("input[name="+e+"]",a);h.length||(h=$("<input>").attr({type:"hidden",name:e}),h.prependTo(a));h.val(f)}document.all?(document.body.insertAdjacentHTML("BeforeEnd",'<iframe name="'+
g+'" src="program/resources/blank.gif" style="width:0;height:0;visibility:hidden;"></iframe>'),e=$('iframe[name="'+g+'"]')):e=$("<iframe>").attr("name",g).css({border:"none",width:0,height:0,visibility:"hidden"}).appendTo(document.body);e.bind("load",{ts:f},d);$(a).attr({target:g,action:this.url(b,{_id:this.env.compose_id||"",_uploadid:f}),method:"POST"}).attr(a.encoding?"encoding":"enctype","multipart/form-data").submit();return g};this.document_drag_hover=function(a,b){a.preventDefault();$(l.gui_objects.filedrop)[b?
"addClass":"removeClass"]("active")};this.file_drag_hover=function(a,b){a.preventDefault();a.stopPropagation();$(l.gui_objects.filedrop)[b?"addClass":"removeClass"]("hover")};this.file_dropped=function(a){this.file_drag_hover(a,!1);var b=a.target.files||a.dataTransfer.files,d=window.FormData?new FormData:null,e=(this.env.filedrop.fieldname||"_file")+(this.env.filedrop.single?"":"[]"),f="------multipartformboundary"+(new Date).getTime(),g="--"+f+"\r\n";if(b&&b.length)for(var h=function(){var a=1<b.length,
e=(new Date).getTime(),a="<span>"+(a?l.get_label("uploadingmany"):b[0].name)+"</span>";l.add2attachment_list(e,{name:"",html:a,classname:"uploading",complete:!1})||(l.file_upload_id=l.set_busy(!0,"uploading"));g+="--"+f+"--\r\n";$.ajax({type:"POST",dataType:"json",url:l.url(l.env.filedrop.action||"upload",{_id:l.env.compose_id||l.env.cid||"",_uploadid:e,_remote:1}),contentType:d?!1:"multipart/form-data; boundary="+f,processData:!1,timeout:0,data:d||g,headers:{"X-Roundcube-Request":l.env.request_token},
xhr:function(){var a=jQuery.ajaxSettings.xhr();!d&&a.sendAsBinary&&(a.send=a.sendAsBinary);return a},success:function(a){l.http_response(a)},error:function(a,b,d){l.http_error(a,b,d,null,"attachment")}})},k=this.env.filedrop.single?0:b.length-1,p=a=0,m;a<=k&&(m=b[p]);p++)if(m.name||(m.name=m.fileName),m.size||(m.size=m.fileSize),m.type||(m.type="application/octet-stream"),!d&&/[^\x20-\x7E]/.test(m.name)&&(m.name_bin=unescape(encodeURIComponent(m.name))),!this.env.filedrop.filter||m.type.match(RegExp(this.env.filedrop.filter))){if(d){if(d.append(e,
m),a==k)return h()}else if(window.FileReader){var n=new FileReader;n.onload=function(a,b){return function(d){g+='Content-Disposition: form-data; name="'+e+'"';g+='; filename="'+(m.name_bin||a.name)+'"\r\n';g+="Content-Length: "+a.size+"\r\n";g+="Content-Type: "+a.type+"\r\n\r\n";g+=n.result+"\r\n";g+="--"+f+"\r\n";if(b==k)return h()}}(m,a);n.readAsBinaryString(m)}else if(m.getAsBinary&&(g+='Content-Disposition: form-data; name="'+e+'"',g+='; filename="'+(m.name_bin||m.name)+'"\r\n',g+="Content-Length: "+
...
0,d=0,e,f,g;"number"==typeof a.selectionStart&&"number"==typeof a.selectionEnd?(e=a.value,b=a.selectionStart,d=a.selectionEnd):(f=document.selection.createRange())&&f.parentElement()==a&&(g=a.value.length,e=a.value,d=a.createTextRange(),d.moveToBookmark(f.getBookmark()),a=a.createTextRange(),a.collapse(!1),-1<d.compareEndPoints("StartToEnd",a)?b=d=g:(b=-d.moveStart("character",-g),b+=e.slice(0,b).split("\n").length-1,-1<d.compareEndPoints("EndToEnd",a)?d=g:(d=-d.moveEnd("character",-g),d+=e.slice(0,
d).split("\n").length-1)));return{start:b,end:d,text:e.substr(b,d-b)}};this.lock_form=function(a,b){if(a&&a.elements){var d,e,f;b&&(this.disabled_form_elements=[]);d=0;for(e=a.elements.length;d<e;d++)if(f=a.elements[d],"hidden"!=f.type)if(b&&f.disabled)this.disabled_form_elements.push(f);else if(b||this.disabled_form_elements&&0>$.inArray(f,this.disabled_form_elements))f.disabled=b}};this.mailto_handler_uri=function(){return location.href.split("?")[0]+"?_task=mail&_action=compose&_to=%s"};this.register_protocol_handler=
...
return!1})}else $(b).addClass("disabled").click(function(){return!1})};this.browser_capabilities_check=function(){this.env.browser_capabilities||(this.env.browser_capabilities={});void 0===this.env.browser_capabilities.pdf&&(this.env.browser_capabilities.pdf=this.pdf_support_check());void 0===this.env.browser_capabilities.flash&&(this.env.browser_capabilities.flash=this.flash_support_check());void 0===this.env.browser_capabilities.tif&&this.tif_support_check()};this.browser_capabilities=function(){if(!this.env.browser_capabilities)return"";
...
if(window.ActiveXObject){try{if(axObj=new ActiveXObject("AcroPDF.PDF"))return 1}catch(f){}try{if(axObj=new ActiveXObject("PDF.PdfCtrl"))return 1}catch(g){}}for(i=0;i<d;i++)if(a=b[i],"String"===typeof a){if(e.test(a))return 1}else if(a.name&&e.test(a.name))return 1;return 0};this.flash_support_check=function(){var a=navigator.mimeTypes?navigator.mimeTypes["application/x-shockwave-flash"]:{};if(a&&a.enabledPlugin)return 1;if(window.ActiveXObject)try{if(axObj=new ActiveXObject("ShockwaveFlash.ShockwaveFlash"))return 1}catch(b){}return 0};
this.set_cookie=function(a,b,d){setCookie(a,b,d,this.env.cookie_path,this.env.cookie_domain,this.env.cookie_secure)};this.get_local_storage_prefix=function(){this.local_storage_prefix||(this.local_storage_prefix="roundcube."+(this.env.user_id||"anonymous")+".");return this.local_storage_prefix};this.local_storage_get_item=function(a,b,d){a=localStorage.getItem(this.get_local_storage_prefix()+a);return null!==a?JSON.parse(a):b||null};this.local_storage_set_item=function(a,b,d){return localStorage.setItem(this.get_local_storage_prefix()+
a,JSON.stringify(b))};this.local_storage_remove_item=function(a){return localStorage.removeItem(this.get_local_storage_prefix()+a)}}rcube_webmail.long_subject_title=function(l,x){if(!l.title){var a=$(l);a.width()+15*x>a.parent().width()&&(l.title=a.text())}};
rcube_webmail.long_subject_title_ex=function(l,x){if(!l.title){var a=$(l),b=$.trim(a.text()),d=$("<span>").text(b).css({position:"absolute","float":"left",visibility:"hidden","font-size":a.css("font-size"),"font-weight":a.css("font-weight")}).appendTo($("body")),e=d.width();d.remove();e+15*x>a.width()&&(l.title=b)}};rcube_webmail.prototype.get_cookie=getCookie;rcube_webmail.prototype.addEventListener=rcube_event_engine.prototype.addEventListener;rcube_webmail.prototype.removeEventListener=rcube_event_engine.prototype.removeEventListener;
