            ...
            if (node) {
                for (lastNodeType = node.nodeType, node = node.previousSibling, lastNode = node; node; node = node.previousSibling) {
                    ...
                    if (normalized && nodeType == 3) {
                        ...
                        try {
                            nodeValueExists = node.nodeValue.length
                            } catch (c) {}
