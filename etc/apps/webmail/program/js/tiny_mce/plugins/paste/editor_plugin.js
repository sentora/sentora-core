(function(){
    ...
    function b(d,e){
        ...
        function h(m,k){
            ...
            m.node=l.create("div",0,m.content);
            if(tinymce.isGecko){
        ...
        f.onPostProcess.dispatch(f,m);
        m.content=d.serializer.serialize(m.node,{
        getInner:1
    });
    if((!k)&&(d.pasteAsPlainText)){
        f._insertPlainText(d,l,m.content);
