...
class rcube_contacts extends rcube_addressbook {
    ...
    function get_group($group_id) {
        $sql_result = $this->db->query(
                ...
                " WHERE del<>1" .
                " AND contactgroup_id=?" .
                " AND user_id=?", $group_id, $this->user_id);
    ...
    function list_records($cols = null, $subset = 0, $nocount = false) {
        ...
        $sql_result = $this->db->limitquery(
                ...
                " " . $this->sort_order, $start_row, $length, $this->user_id, $this->group_id);
    ...
    private function _count() {
        ...
        $sql_result = $this->db->query(
                ...
                " AND c.user_id=?" .
                ($this->group_id ? " AND m.contactgroup_id=?" : "") .
                ($this->filter ? " AND (" . $this->filter . ")" : ""), $this->user_id, $this->group_id
        );
    ...
    function delete($ids, $force = true) {
        ...
        $this->db->query(
                ...
                " WHERE user_id=?" .
                " AND contact_id IN ($ids)", $this->user_id
        );
    ...
    function rename_group($gid, $newname) {
        ...
        $sql_result = $this->db->query(
                ...
                " WHERE contactgroup_id=?" .
                " AND user_id=?", $name, $gid, $this->user_id
        );
    ...
    function add_to_group($group_id, $ids) {
        ...
        $sql_result = $this->db->query(
                ...
                " WHERE contactgroup_id=?" .
                " AND contact_id IN (" . $this->db->array2list($ids, 'integer') . ")", $group_id
        );
        while ($sql_result && ($sql_arr = $this->db->fetch_assoc($sql_result))) {
        ...
        foreach ($ids as $contact_id) {
            $this->db->query(
                    ...
                    " VALUES (?, ?, " . $this->db->now() . ")", $group_id, $contact_id
            );
    ...
    function remove_from_group($group_id, $ids) {
        ...
        $sql_result = $this->db->query(
                ...
                " WHERE contactgroup_id=?" .
                " AND contact_id IN ($ids)", $group_id
        );
    ...
    private function unique_groupname($name) {
        ...
        do {
            $sql_result = $this->db->query(
                    ...
                    " WHERE del<>1" .
                    " AND user_id=?" .
                    " AND name=?", $this->user_id, $checkname);
