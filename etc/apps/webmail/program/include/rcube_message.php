...
class rcube_message {
    ...
    private function parse_structure($structure, $recursive = false) {
        ...
        $plugin = $this->app->plugins->exec_hook('message_part_structure', array('object' => $this, 'structure' => $structure,
        ...
        // message contains multiple parts
            ...
            for ($i = 0; $i < count($structure->parts); $i++) {
                ...
                // part text/[plain|html] or delivery status
                    ...
                    $plugin = $this->app->plugins->exec_hook('message_part_structure', array('object' => $this, 'structure' => $mail_part,
