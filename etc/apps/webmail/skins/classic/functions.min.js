...
3==a.nodeType;)a=a.nextSibling;return a},prev_sibling:function(a){for(a=a.previousSibling;a&&3==a.nodeType;)a=a.previousSibling;return a},enable_command:function(a){"reply-list"==a.command&&1==rcmail.env.reply_all_mode&&(a=rcmail.gettext(a.status?"replylist":"replyall"),$("a.button.replyAll").attr("title",a))}};
...
("down"==a&&(c*=-1),this.list.get(0).scrollTop+=c,this.ts=window.setTimeout(function(){b.scroll(a)},this.step_time))}}function iframe_events(){try{rcube_event.add_listener({element:this.contentDocument?this.contentDocument:this.contentWindow?this.contentWindow.document:null,object:rcmail_ui,method:"body_mouseup",event:"mouseup"})}catch(a){}}
