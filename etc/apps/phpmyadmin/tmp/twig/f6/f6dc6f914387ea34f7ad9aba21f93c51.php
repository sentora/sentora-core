...
";
    ...
    {
        return new Source("", "display/results/table_navigation_button.twig", "/etc/sentora/panel/etc/apps/phpmyadmin/templates/display/results/table_navigation_button.twig");
    }
}
