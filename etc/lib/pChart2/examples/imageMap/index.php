<?php if (isset($_GET["Action"]) && $_GET["Action"] == "ViewPHP") {
    $Script = $_GET["Script"];
    highlight_file($Script);
    exit();
} ?>
<?php if (isset($_GET["Action"]) && $_GET["Action"] == "ViewHTML") {
    $Script = $_GET["Script"];
    writeHTML($Script);
    exit();
} ?>
                    ...
                    <table style='border: 2px solid #FFFFFF;'><tr><td>
                                ...
                                <div style='border: 3px solid #D0D0D0; border-top: 1px solid #FFFFFF; background-color: #FAFAFA; width: 220px; overflow: auto'>
                                    ...
                                    foreach ($Tree as $Key => $Element) {
                                        if ($Key == count($Tree) - 1) {
                                            $Icon = "../resources/dash-explorer-last.png";
                                        } else {
                                            $Icon = "../resources/dash-explorer.png";
                                        }
