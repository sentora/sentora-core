...
INSERT INTO `x_modules` VALUES ('26', '8', 'FTP Accounts', '100', 'ftp_management', 'user', 'Using this module you can create FTP accounts which will enable you and any other accounts you create to have the ability to upload and manage files on your hosting space.', '0', 'true', '', '');
...
INSERT INTO `x_settings` VALUES ('37', 'smtp_secure', 'SMTP Auth method', 'ssl', 'false|ssl|tls', 'If specified will attempt to use encryption to connect to the server, if \'false\' this is disabled. Available options: false, ssl, tls', 'ZPanel Config', 'true');
...
INSERT INTO `x_settings` VALUES ('100', 'apache_restart', 'Apache Restart Cmd', '-k restart -n \"Apache\"', null, 'Command line arguments used after the restart service request when reloading Apache.', 'Apache Config', 'true');
...
INSERT INTO `x_settings` VALUES ('106', 'htpasswd_exe', 'htpassword Exe', 'htpasswd', null, 'Path to htpasswd.exe for protecting directories with .htaccess', 'Apache Config', 'false');
...
INSERT INTO `x_settings` VALUES ('114', 'debug_mode', 'ZPanel Debug Mode', 'dev', 'dev|prod', 'Whether or not to show PHP debug errors,warnings and notices', 'ZPanel Config', 'true');
...
INSERT INTO `x_translations` VALUES ('113', 'Secure FTP Applet is a JAVA based FTP client component that runs within your web browser. It is designed to let non-technical users exchange data securely with an FTP server.', 'Secure FTP Applet ist eine Java-basierte FTP-Client-Komponente, die in Ihrem Web-Browser läuft. Es wurde entwickelt, um nicht-technische Anwender den Datenaustausch secureiy lassen mit einem FTP-Server.');
