...
INSERT INTO `x_settings` VALUES ('27', 'logfile', null, 'C:/zpanel/logs/daemon_log.txt', null, 'If loggging is set to \'file\' mode this is the path to the log file that is to be used by ZPanel.', 'ZPanel Config', 'false');
