...
insert  into `x_faqs`(`fq_id_pk`,`fq_acc_fk`,`fq_question_tx`,`fq_answer_tx`,`fq_global_in`,`fq_created_ts`,`fq_deleted_ts`) values (2,1,'How do I change my password?','Your ZPanel and MySQL password can be easily changed using the \'Password assistant\' icon on the control panel.',1,NULL,NULL);
...
insert  into `x_faqs`(`fq_id_pk`,`fq_acc_fk`,`fq_question_tx`,`fq_answer_tx`,`fq_global_in`,`fq_created_ts`,`fq_deleted_ts`) values (5,1,'Can I view my sites Stats?','Your Websites stats can be viewed by accessing the Webalizer Stats Module under Advanced. It has numerous different displays which gives you access to all the information about your domains and sites.',1,NULL,NULL);
insert  into `x_faqs`(`fq_id_pk`,`fq_acc_fk`,`fq_question_tx`,`fq_answer_tx`,`fq_global_in`,`fq_created_ts`,`fq_deleted_ts`) values (6,1,'How can I generate Meta Data for my page?','ZPanel has a Meta Generator which can be found under Advanced. It allows you to create Meta Information in seconds and easily copy them into the web page.',1,NULL,NULL);
...
insert  into `x_settings`(`so_id_pk`,`so_name_vc`,`so_cleanname_vc`,`so_value_tx`,`so_defvalues_tx`,`so_desc_tx`,`so_module_vc`,`so_usereditable_en`) values (27,'logfile','ZPanel Log file','/etc/zpanel/logs/zpanel.log',NULL,'If loggging is set to \'file\' mode this is the path to the log file that is to be used by ZPanel.','ZPanel Config','true');
...
insert  into `x_settings`(`so_id_pk`,`so_name_vc`,`so_cleanname_vc`,`so_value_tx`,`so_defvalues_tx`,`so_desc_tx`,`so_module_vc`,`so_usereditable_en`) values (46,'ftp_db','FTP Database','zpanelx_proftpd',NULL,'The name of the ftp server database','FTP Config','true');
...
insert  into `x_settings`(`so_id_pk`,`so_name_vc`,`so_cleanname_vc`,`so_value_tx`,`so_defvalues_tx`,`so_desc_tx`,`so_module_vc`,`so_usereditable_en`) values (51,'mailserver_db','Mailserver Database','zpanelx_postfix',NULL,'The name of the mail server database','Mail Config','true');
...
insert  into `x_settings`(`so_id_pk`,`so_name_vc`,`so_cleanname_vc`,`so_value_tx`,`so_defvalues_tx`,`so_desc_tx`,`so_module_vc`,`so_usereditable_en`) values (71,'apache_vhost','Apache VHOST Conf','/etc/zpanel/configs/apache/httpd-vhosts.conf',NULL,'The full system patch and filename of the Apache VHOST configuration name.','Apache Config','true');
...
insert  into `x_settings`(`so_id_pk`,`so_name_vc`,`so_cleanname_vc`,`so_value_tx`,`so_defvalues_tx`,`so_desc_tx`,`so_module_vc`,`so_usereditable_en`) values (105,'cron_file','Cron File','/etc/crontab.d',NULL,'Path to the user cron file','Cron Config','true');
