...
insert  into `x_settings`(`so_name_vc`,`so_cleanname_vc`,`so_value_tx`,`so_defvalues_tx`,`so_desc_tx`,`so_module_vc`,`so_usereditable_en`) values ('zpanel_port','Sentora Panel Port','80',NULL,'Sentora Panel Port','ZPanel Config','true');
